...
const ENEMIES = {
  ...
  shadow_knight: { name: "Shadow Knight", desc: "A towering figure in armour of living shadow. It moves with fluid grace, its blade trailing darkness. The Hollow Steward's bailiff - stitched from taken shadow, sent to enforce.", hp: 85, maxHp: 85, attack: 16, defense: 10, xp: 55, gold: 0, loot: "shadow_plate", undead: false, shadowBeing: true,
  ...
  shadow_lord: { name: "The Hollow Steward", desc: "Steward Malchor - or the punishment wearing his shape. A figure of curdled shadow in the tatters of household finery, the Toll-Rod in its grip. Where its eyes should be, pale ledger-script scrolls and scrolls. Its voice arrives like an invoice: exact, itemized, patient.", hp: 150, maxHp: 150, attack: 20, defense: 12, xp: 100, gold: 0, loot: "scepter_of_aethon", undead: false, shadowBeing: true, boss: true, regenerates: true,
