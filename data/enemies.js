...
const ENEMIES = {
  ...
  shadow_knight: { name: "Shadow Knight", desc: "A towering figure in armor of living shadow. It moves with fluid grace, its blade trailing darkness. The Hollow Steward's bailiff — stitched from taken shadow, sent to enforce.", hp: 85, maxHp: 85, attack: 16, defense: 10, xp: 55, gold: 0, loot: "shadow_plate", undead: false, shadowBeing: true,
