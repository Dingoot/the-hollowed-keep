...
const ROOMS = {
  ...
  gatehouse: {
    ...
    npcs: ["porter"],
    search: "Behind the table, carved into the wall by many hands across many years: 'The dead walk below. Steel is nothing. Bring silver.' A small tin holds flint and dry tinder. The ledger, whenever you glance at it, is closed. It was closed when you looked, anyway.",
  },
  main_courtyard: {
  ...
  armory: {
    ...
    search: "Behind a loose stone in the wall: a quiver of bolts, still usable. The armor stand has a nameplate: 'Honor Guard of the First Steward — Polished Daily.' Someone, or something, is still keeping to the schedule.",
    searchItems: ["bolts"],
  },
  guard_room: {
    name: "The Guard Room",
  ...
  sanctum: {
    name: "The Sanctum",
    region: "The Deep",
    desc: "Beyond the throne, hidden by its shadow, a small chamber of perfect white stone—startlingly bright after the darkness. In the center, a pedestal holds a crown grown from fragments — silver, starlight, and the unmistakable shimmer of things people used to be. The walls are covered in writing—not carved but grown, like crystal formations—in a language that predates human speech. Somehow, you can read it. It says: 'The Keep is the door. The Rod is the key. You are the choice.'",
