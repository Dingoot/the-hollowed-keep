...
const NPCS = {
  porter: {
    name: "The Porter",
    desc: "A tall figure in a gatekeeper's coat mended so many times the original cloth is a rumor. Its face is not hidden, merely difficult — the way a word can be difficult to recall. It stands by the portcullis chains, holding a ledger that is closed.",
    greeting: "'Ah. The new arrival.' The Porter does not consult the ledger. 'Received: one self, standard toll. No refunds, before you ask. Everyone asks. Terms are terms.'",
    topics: {
      toll: "'Paid at the threshold. Name, past, trade, loves. The Keep is not particular about denominations; it takes the whole purse.' A pause. 'It left you the blood and one keepsake. It always leaves the blood. Sentimental, in its way.'",
      terms: "'Written on the gate, in the language you knew before. Not my drafting. I only witness.' Its grip tightens fractionally on the ledger. 'I signed the same terms once. I no longer recall what I paid. That is the punchline, if you were waiting for one.'",
      back: "'The gates open inward. That is the whole of their design.' It says this gently, the way one tells a child about winter.",
      down: "'What the Keep takes, settles. Selves sink. Yours is down there now, in the deep hoard with everyone else's. I am told the descent is educational.'",
      keepsake: "'Check your pockets. The Toll misses one thing per soul. Missed, or left — the distinction is above my station.'",
    },
  },
  wick: {
    name: "Wick",
